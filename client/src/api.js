 ...
 * @returns {Promise<object>} Object containing organization details.
 */
 ...
 * @param {string} idToken - The user's Firebase ID token for authentication.
 * @param {number} orgId - The organization ID to follow.
 * @returns {Promise<object>} Success confirmation.
 */
export async function followOrganization(idToken, orgId) {
    return apiRequest(`/api/organizations/${orgId}/follow`, {
        method: "POST"
    }, idToken);
}
 ...
 * @param {string} idToken - The user's Firebase ID token for authentication.
 * @param {number} orgId - The organization ID to unfollow.
 * @returns {Promise<object>} Success confirmation.
 */
export async function unfollowOrganization(idToken, orgId) {
    return apiRequest(`/api/organizations/${orgId}/unfollow`, {
        method: "POST"
    }, idToken);
}
 ...
 * @param {string} idToken - The user's Firebase ID token for authentication.
 * @param {number} orgId - The organization ID to join.
 * @returns {Promise<object>} Success confirmation.
 */
export async function joinOrganization(idToken, orgId) {
    return apiRequest(`/api/organizations/${orgId}/join`, {
        method: "POST"
    }, idToken);
}
 ...
 * @param {string} idToken - The user's Firebase ID token for authentication.
 * @param {number} orgId - The organization ID to leave.
 * @returns {Promise<object>} Success confirmation.
 */
export async function leaveOrganization(idToken, orgId) {
    return apiRequest(`/api/organizations/${orgId}/leave`, {
        method: "POST"
    }, idToken);
}
 ...
 * @param {string} idToken - The user's Firebase ID token for authentication.
 * @returns {Promise<object>} Object containing user's organizations.
 */
export async function getUserOrganizations(idToken) {
    return apiRequest("/api/user/organizations", {
        method: "GET"
    }, idToken);
}
